...
<body>
   ...
   <section>
       <div class="row">
           ...
           <h2>Search Teacher by Employee Id</h2><br>
            ...
            <?php
               ...
               if(isset($_POST['add'])){
                   ...
                   while($edit_id=$edit->fetch_object())
                   {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3 class="text-center" style="	color:#2196f3;font-weight:600">Teacher's Information</h3><hr><br>
                <form action="" method="POST" entype="multipart/form-data">
					<div class="form-group">
						<label for="">Employee No</label>
						<input name="e_id" class="form-control" value="<?php echo $edit_id->e_id; ?>" type="text" disabled>
					</div>
					<div class="form-group">
                    ...
                    <div class="form-group">
						...
						<input name="sub" class="form-control" value="<?php echo $edit_id->subject; ?>" type="text" disabled>
					</div>
                    <div class="form-group">
