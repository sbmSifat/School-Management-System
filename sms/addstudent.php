    ...
    <?php
      if(isset($_POST['add'])){
          ...
          if(empty($_POST['roll_no']) || empty($_POST['fname'])|| empty($_POST['lname'])||empty($_POST['mname'])||empty($_POST['faname'])||empty($_POST['dob']) || empty($_POST['email'])||empty($_POST['mobile'])|| empty($_POST['class'])||empty($_POST['address'])||empty($_POST['gender'])){
            ...
            connect()->query("INSERT INTO students(roll_no,fname,lname,mother_name,father_name,dob,email,password,mobile,class,address,gender) VALUES('$roll_no','$fname','$lname','$mname','$faname','$dob','$email','$pass','$mobile','$class','$address','$gender')");
