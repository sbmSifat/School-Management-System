...
<?php 
		if(isset($_POST['add'])){
            ...
            connect()->query("DELETE FROM teachers WHERE e_id LIKE '$roll'");
   ...
   <section>
       <div class="row">
           ...
           <h2>Delete Teacher by Employee Id</h2><br>
            <form action="" method="POST">
                <div class="form-group">
                    <p style="color:#8a6600;font-weight:600">Delete by Employee Id: </p><input type="text" class="w-25;margin-left:120px" name="roll" class="form-control">
