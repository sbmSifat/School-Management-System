...
<?php 
    if(isset($_POST['add'])){
        ...
        if(empty($email) || empty($pass)){
            ...
            $login_data=authcheck('teachers','email',$email);
              if($login_data !== false){
                if($pass == $login_data->password){
                    $_SESSION['id']=$login_data->e_id;
                    ...
                    $_SESSION['subject']=$login_data->subject;
   ...
   ?>
    <div class="warp">
       <img style="width:200px; display:block;margin:0 auto;" src="media/b3.png" alt="b3">
        <div class="card log">
            <div class="card-body">
                <h2 style="color:#8A6600;"class="text-center logh2">Teacher Login</h2>
                <?php
                     if(isset($msg)){
                       echo $msg;
                     }
